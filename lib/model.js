...
var Model = Class(function() {
    ...
    return {
            ...
            return this.getPk().then(function(pk) {
                ...
                return self.instance.select(options).then(function(rows) {
                    rows = rows.map(function(row) {
                        return self.parseFieldsMap(row);
                    });
        ...
        find: function(options) {
            ...
            return this.getPk().then(function(pk) {
                ...
                return self.instance.select(options).then(function(result) {
                    return result[0] ? self.parseFieldsMap(result[0]) : null;
                });
            });
        },
        ...
        insert: function(data, options, replace) {
            return add(data, options, replace);
        },
        ...
        count: function(field) {
            ...
            field = !_.isEmpty(field.trim()) ? this.instance.parseKey(field) : '*';
            return this.getField('COUNT(' + field + ')').then(function(result) {
                return result[0];
            });
        },
        ...
        sum: function(field) {
            ...
            return this.getField('SUM(' + field + ')').then(function(result) {
                return result[0];
            });
        },
        ...
        min: function(field) {
            ...
            return this.getField('MIN(' + field + ')').then(function(result) {
                return result[0];
            });
        },
        ...
        max: function(field) {
            ...
            return this.getField('MAX(' + field + ')').then(function(result) {
                return result[0];
            });
        },
        ...
        avg: function(field) {
            ...
            return this.getField('AVG(' + field + ')').then(function(result) {
                return result[0];
            });
        },
        ...
        getFieldBy: function(field, value, fields) {
            ...
            return this.where(where).getField([].slice.call(arguments, 2));
        },
        ...
        autoOperation: function(data, type) {
            ...
            if (_.isObject(auto)) {
                // array(field, value, type, rule, param)
        ...
        // TODO: Complete other validate rule.
