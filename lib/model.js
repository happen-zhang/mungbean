...
var Model = Class(function() {
    ...
    return {
        ...
        limit: function(limit, length) {
            ...
            this.options.limit = parseInt(limit) + (length ? ',' + parseInt(length) : '');
        ...
        page: function(page, listRows) {
            ...
            this.options.page = [parseInt(page), parseInt(listRows)];
            return this;
        },
        ...
        autoValidation: function(data, type) {
            ...
            if (validate) {
                ...
                validate.forEach(function(item, key) {
                    if (!_isset(item[5]) || item[5] == MODEL_BOTH || item[5] == type) {
        ...
        validationField: function(data, item) {
            if (this.patchValidate && _.isset(this.error[item[0]])) {
                return ;
            }

            if (this.validationFieldItem(data, item)) {
                if (this.patchValidate) {
